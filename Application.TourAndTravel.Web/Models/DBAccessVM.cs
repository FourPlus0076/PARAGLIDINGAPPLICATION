...
namespace Application.TourAndTravel.Web.Models
{
    public class DBAccessVM : DbContext
    {
        ...
        public DbSet<ParaglidingDetails> paraglidingDetails { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new ParaglidingDetailsMap());
        }
        ...
        public class ParaglidingDetailsMap : EntityTypeConfiguration<ParaglidingDetails>
        {
            public ParaglidingDetailsMap()
            {
                this.ToTable("ParaglidingDetails");
            }
        }
